...
* 一个程序使用包含在指令中的 **program\_id**、**accounts** 列表和 **instruction\_data** 来处理指令
...
要使用 Rust 编写 Solana 程序，我们使用 `solana_program` crate。`solana_program` crate 充当 Solana 程序的标准库。该标准库包含我们将用于开发 Solana 程序的模块和宏。如果您想更深入了解 `solana_program` crate，请查看[`solana_program` crate 文档](https://docs.rs/solana-program/latest/solana\_program/index.html)。
